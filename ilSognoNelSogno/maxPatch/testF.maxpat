...
,
		"rect" : [ 243.0, 273.0, 376.0, 431.0 ],
		"bglocked" : 0,
		"defrect" : [ 243.0, 273.0, 376.0, 431.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "testF will make a test of the inflow float data and gate or not it's flow. If the data is the same from the previous data value flow will be stopped, else if the data value will be different from the previous the data flow will be permitted.",
					"linecount" : 4,
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 45.0, 360.0, 62.0 ],
					"id" : "obj-4",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 2,
					"patching_rect" : [ 30.0, 270.0, 214.0, 20.0 ],
					"outlettype" : [ "", "" ],
					"id" : "obj-64",
					"fontname" : "Arial"
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-6", 0 ],
					"hidden" : 0,
					"midpoints" : [ 234.5, 291.0, 222.0, 291.0, 222.0, 297.0, 219.5, 297.0 ]
				}
