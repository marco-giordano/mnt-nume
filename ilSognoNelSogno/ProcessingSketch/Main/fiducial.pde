...
void fiducial(int ID, float X, float Y, float rotation, int R, int G,int B){
     ...
     rotate(rotation); // fiducial rotation
     ...
     stroke(255*rotation); // text and pinter edge color
     fill(255*rotation); // text and pinter color
